...
class EdgeAlert {
  static final int lenghtShort = 1; //1 seconds
  static final int lenghtLong = 2; // 2 seconds
  static final int lenghtVeryLong = 3; // 3 seconds

  static final int posTop = 1;
  static final int posBottom = 2;
    ...
    if (!_isVisible) {
      ...
      _overlayEntry = OverlayEntry(builder: (context) {
        return EdgeOverlay(
          title: title,
          description: description,
          overlayDuration: duration == null ? EdgeAlert.lenghtShort : duration,
          gravity: gravity == null ? EdgeAlert.posTop : gravity,
          backgroundColor:
